...
{
    return [[TFFileManager pathForApplicationSupportDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[TFFileManager pathForCachesDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[TFFileManager pathForDocumentsDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[TFFileManager pathForLibraryDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[TFFileManager pathForMainBundleDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[TFFileManager pathForTemporaryDirectory] stringByAppendingPathComponent:path];
}
